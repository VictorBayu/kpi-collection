...
export const FIELDS_INSENTIF: FieldDef[] = [
  { key: "nik",        label: "NIK karyawan", type: "nik",     required: true,
    aliases: ["nik", "nama", "nama pic", "pic", "karyawan"] },
  { key: "jabatan",    label: "Jabatan",      type: "text",    required: false,
    aliases: ["jabatan", "posisi", "position"] },
  { key: "cabang",     label: "Cabang",       type: "text",    required: false,
    aliases: ["cabang", "branch", "area"] },
  { key: "kategori",   label: "Kategori",     type: "text",    required: true,
    aliases: ["indikator", "kategori", "jenis insentif", "item"] },
  { key: "produk",     label: "Produk",       type: "text",    required: false,
    aliases: ["produk", "product"] },
  { key: "bobot",      label: "Bobot/Syarat", type: "text",    required: false,
    aliases: ["bobot", "syarat", "weight"] },
  { key: "saldo_awal", label: "Saldo awal",   type: "number",  required: false,
    aliases: ["saldo awal", "saldo", "os awal", "bahan"] },
  { key: "pencapaian", label: "Pencapaian",   type: "number",  required: false,
    aliases: ["pencapaian", "realisasi", "achievement", "penyelesaian"] },
  { key: "rasio",      label: "% pencapaian", type: "percent", required: false,
    aliases: ["pencapaian", "capai", "persen", "ratio", "achv"] },
  { key: "skor_kpi",   label: "Skor KPI",     type: "number",  required: false,
    aliases: ["kpi", "score kpi", "skor"] },
  { key: "nominal",    label: "Nominal insentif", type: "number", required: false,
    aliases: ["insentif", "jumlah", "nominal", "amount", "reward"] },
  { key: "keterangan", label: "Keterangan",   type: "text",    required: false,
    aliases: ["text", "keterangan", "notes", "catatan"] },
];
