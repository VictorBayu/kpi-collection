...
type Pagu = {
  ...
  skor_minimal: string; pembagi: string; aktif: boolean; pemakai: number;
};
    ...
    <>
      <div className="sectionhead">
        ...
        <button className="btn sm"
                onClick={() => setBaru({
                  ...
                  skor_minimal: "3", pembagi: "5", aktif: true, pemakai: 0,
                })}>
          + Tambah pagu
        </button>
      </div>
      ...
      <section className="card">
        ...
        <table className="rapat tbl-pagu">
          <colgroup>
            <col /><col style={{ width: 88 }} /><col style={{ width: 150 }} />
