 ...
 * ditampilkan, supaya kelihatan mana yang tersaring dan kenapa — bukan
 * cuma mana yang lolos.
 */
function ContohBahan({ c, berjalan }: { c: any; berjalan: boolean }) {
  ...
  return (
    <details className="trc-contoh" open={buka} onToggle={(e) => setBuka((e.target as HTMLDetailsElement).open)}>
