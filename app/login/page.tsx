    ...
    <div className="loginpage">
      <div className="loginwrap">
        <aside className="loginside">
          ...
          <div className="z">
            <span className="login-pita"><i aria-hidden /> Portal KPI &amp; insentif bulanan</span>
            <h1>Lihat skor dan insentif Anda bulan ini.</h1>
            <p>
              Data KPI diterbitkan tim data setiap awal bulan. Pantau progres harian,
              lihat perhitungan insentif secara transparan, dan ajukan koreksi langsung
              dari aplikasi.
            </p>

            <div className="login-pratinjau" aria-hidden>
              <div className="lp-atas">
                <span className="lp-ikon"><Ikon nama="wallet" ukuran={20} /></span>
              ...
              <div className="lp-baris"><span>Pencapaian indikator</span><span>Target KPI 5</span></div>
              <div className="lp-track"><i style={{ width: "78%" }} /></div>
              <div className="lp-stat">
                <span><small>Skor KPI</small><b className="num">4,20</b></span>
                <span><small>Indikator</small><b className="num">6 / 7</b></span>
                <span><small>Tier</small><b className="num">KPI 4</b></span>
              </div>
            </div>
          </div>

          <div className="z login-kaki">
            <span><Ikon nama="shield" ukuran={16} /> Akses sesuai peran</span>
            <span><Ikon nama="gauge" ukuran={16} /> Progres harian &amp; bulanan</span>
          </div>
        </aside>

        <main className="loginform">
          <div className="inner">
            <span className="login-portal"><Ikon nama="badge" ukuran={15} /> Portal staf internal</span>
            <h2>Masuk ke Dasbor</h2>
            <p className="muted mb">Gunakan Nomor Induk Karyawan (NIK) dan password kepegawaian Anda.</p>
            <LoginForm />
